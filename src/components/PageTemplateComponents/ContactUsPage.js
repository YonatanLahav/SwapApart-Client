          ...
          <Grid container spacing={4} sx={{ flexDirection: 'row'  }} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Card sx={{ height: 250, width: 270, flexDirection: 'column' }}>                 
                  ...
                  <CardContent sx={{ flexGrow: 1 }} >
                    ...
                    <Typography  style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <a href='#' onClick={()=>window.open('https://www.linkedin.com/in/roy-maman-68b924238/')}>Roy's Profile </a>                  
                    </Typography >                    
                    <a style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} href='#' onClick={()=>window.open('https://www.linkedin.com/in/yonatan-lahav/')}>Yonatan's Profile </a>
                  </CardContent>
                </Card>
